...
DROP TABLE IF EXISTS gosiss_bg CASCADE;
CREATE TABLE gosiss_bg as
with pvt as
...
(
  ...
  having count(case when label = 'SPECIMEN' then value else null end)<2
...
-- ventilation stuff that is sometimes input
-- , INTUBATED
-- , TIDALVOLUME
-- , VENTILATIONRATE
-- , VENTILATOR
